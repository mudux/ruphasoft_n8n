          ...
          options: [
            {
              ...
              values: [
                ...
                },
                {
                  ...
                  type: 'options',
                  options: [
                    { name: 'First Name', value: 'name[0].given[0]' },
                    { name: 'Last Name', value: 'name[0].family' },
                    { name: 'Full Name', value: 'name[0].text' },
                    { name: 'Birth Date', value: 'birthDate' },
                    { name: 'Gender', value: 'gender' },
                    { name: 'Phone', value: 'telecom[0].value' },
                    { name: 'Email', value: 'telecom[1].value' },
                    { name: 'Medical Record Number', value: 'identifier[0].value' },
                    { name: 'SSN', value: 'identifier[1].value' },
                    { name: 'Address Line', value: 'address[0].line[0]' },
                    { name: 'City', value: 'address[0].city' },
                    { name: 'State', value: 'address[0].state' },
                    { name: 'ZIP Code', value: 'address[0].postalCode' },
                    { name: 'Country', value: 'address[0].country' }
                  ],
                  default: 'name[0].given[0]',
