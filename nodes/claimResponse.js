          ...
          options: [
            {
              ...
              values: [
                ...
                },
                {
                  ...
                  type: 'options',
                  options: [
                    { name: 'Claim ID', value: 'identifier[0].value' },
                    ...
                    { name: 'Total Amount', value: 'total[0].amount.value' },
                    { name: 'Total Currency', value: 'total[0].amount.currency' },
                    { name: 'Payment Amount', value: 'payment.amount.value' },
                    { name: 'Payment Currency', value: 'payment.amount.currency' },
                    { name: 'Payment Date', value: 'payment.date' },
                    { name: 'Adjudication Code', value: 'item[0].adjudication[0].category.coding[0].code' },
                    { name: 'Adjudication Amount', value: 'item[0].adjudication[0].amount.value' },
                    { name: 'Error Code', value: 'error[0].code.coding[0].code' },
                    { name: 'Error Detail Text', value: 'error[0].detail.text' }
                  ],
